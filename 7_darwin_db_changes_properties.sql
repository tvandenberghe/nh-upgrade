...
insert into property_type (type) values('elevation') on conflict (type) do nothing;
...
insert into property_tag_authority (tag_authority_ref, tag_authority_match_predicate, property_type_id) select ta.id, 'owl:sameAs', pt.id from tag_authority ta,property_type pt where ta.urn='SDN:P01::ADEPZZ01' and pt.type='sampling_depth' ON CONFLICT (tag_authority_ref, property_type_id, tag_authority_match_predicate) DO NOTHING;
insert into property_tag_authority (tag_authority_ref, tag_authority_match_predicate, property_type_id) select ta.id, 'owl:sameAs', pt.id from tag_authority ta, property_type pt where ta.urn='SDN:Q01::Q0100004' and pt.type='preparation' ON CONFLICT (tag_authority_ref, property_type_id, tag_authority_match_predicate) DO NOTHING;
insert into property_tag_authority (tag_authority_ref, tag_authority_match_predicate, property_type_id) select ta.id, 'owl:sameAs', pt.id from tag_authority ta, property_type pt where ta.urn='SDN:Q01::Q0100002' and pt.type='sampling_gear' ON CONFLICT (tag_authority_ref, property_type_id, tag_authority_match_predicate) DO NOTHING;
insert into property_tag_authority (tag_authority_ref, tag_authority_match_predicate, property_type_id) select ta.id, 'owl:sameAs', pt.id from tag_authority ta, property_type pt where ta.code='Q2633778' and pt.type='elevation' ON CONFLICT (tag_authority_ref, property_type_id, tag_authority_match_predicate) DO NOTHING;
insert into property_tag_authority (tag_authority_ref, tag_authority_match_predicate, property_type_id) select ta.id, 'skos:broader', pt.id from tag_authority ta, property_type pt where ta.urn='SDN:P01::ADEPZZ01' and pt.type in ('sampling_depth_end', 'sampling_depth_max', 'sampling_depth_min', 'sampling_depth_start') ON CONFLICT (tag_authority_ref, property_type_id, tag_authority_match_predicate) DO NOTHING;
...
update properties set property_type_ref=(select id from property_type where type='elevation') where property_type='altitude';
