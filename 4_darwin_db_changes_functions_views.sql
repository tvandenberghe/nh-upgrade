...
WHERE start_latitude.value is not null and start_latitude.value<>0 and start_longitude.value<>0
union
SELECT distinct gtu.id as gtu_ref,
...
FROM	gtu		
		...
		left join coordinates_cte AS coordinate_precision ON gtu.id = coordinate_precision.record_id AND coordinate_precision.property = 'coordinatePrecision' 
		left join coordinates_cte AS lambert_coordinates_x_y ON gtu.id = lambert_coordinates_x_y.record_id AND lambert_coordinates_x_y.property = 'lambert_coordinates_x_y'
WHERE decimal_start_latitude.value is not null and decimal_start_latitude.value<>0 and decimal_start_longitude.value<>0
union
SELECT distinct gtu.id as gtu_ref,
...
FROM	gtu		
		...
		left join coordinates_cte AS coordinate_precision ON gtu.id = coordinate_precision.record_id AND coordinate_precision.property = 'coordinatePrecision' 
		left join coordinates_cte AS lambert_coordinates_x_y ON gtu.id = lambert_coordinates_x_y.record_id AND lambert_coordinates_x_y.property = 'lambert_coordinates_x_y'
WHERE decimal_latitude.value is not null and decimal_latitude.value<>0 and decimal_longitude.value<>0
union
SELECT distinct gtu.id as gtu_ref,
